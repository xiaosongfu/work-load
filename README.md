...
./mvnw package
```
It produces the `work-load-1.0.0-runner.jar` file in the `/target` directory.
...
The application is now runnable using `java -jar target/work-load-1.0.0-runner.jar`.
...
You can then execute your native executable with: `./target/work-load-1.0.0-runner`
